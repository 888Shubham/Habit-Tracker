import HabitRepository from "../models/habits.repository.js";
...
export default class HabitController{
    ...
    async getHabitList(req, res) {
        try {
            ...
            const habitArray = await this.habitRepository.getHabitList();
    ...
    async getRecordPage(req, res) {
        try {
            ...
            const habitObj = await this.habitRepository.getRecordPage(habitId);
    ...
    async addHabit(req, res) {
        try {
            ...
            const newHabit = await this.habitRepository.addHabit(req.body);
            if (newHabit) {
    ...
    async changeStatus(req, res) {
        try {
            ...
            await this.habitRepository.changeStatus(habitId, day);
